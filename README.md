...
```mermaid
flowchart LR
    A[🗣️ Natural Language Prompt] --> B[🤖 Large Language Model]
    B --> C[🐍 Geoscience Code\nPython · GIS · Remote Sensing]
    C --> D[🌍 Spatial Analysis\nGeodata Processing · Modeling]

    style A fill:#0c4a6e,stroke:#38bdf8,color:#e0f2fe
    style B fill:#1e3a5f,stroke:#38bdf8,color:#e0f2fe
    style C fill:#0c4a6e,stroke:#38bdf8,color:#e0f2fe
    style D fill:#164e63,stroke:#38bdf8,color:#e0f2fe
```
...
![GDAL](https://img.shields.io/badge/GDAL-5CAD44?style=for-the-badge&logoColor=white)
